...
# Dynamically find the project root by looking for the .env file
...
if [ -f "$ENV_FILE" ]; then
    # Strip Windows line endings to prevent SSH connection errors
...
SSH_PORT=2222
SSH_USER="root"
# Explicitly targeting the .ssh folder at the Project Root
